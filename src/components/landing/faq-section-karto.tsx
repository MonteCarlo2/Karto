...
const faqItems = [
  {
    ...
    content:
      "Наша платформа — это инструмент для всех, кто занимается коммерцией. Она создана для селлеров на любых маркетплейсах (Wildberries, Ozon, Яндекс Маркет и др.), позволяя быстро создать упаковку товара. В режиме «Свободное творчество» сервис также полезен дизайнерам и маркетологам, которым нужны уникальные изображения и видео без затрат на студийную съёмку.",
  },
  {
  ...
  },
  {
    ...
    content:
      "Поток — это автоматизированный бизнес-процесс: вы получаете до 12 вариаций дизайна, готовое SEO-описание и анализ цен в одном цикле. Свободное творчество — это ваша личная мастерская: вы генерируете любые изображения и видео по своим правилам и промптам без привязки к маркетинговому сценарию. Кадры изображений и видео-кредиты приобретаются отдельными пакетами.",
  },
  {
    title: "Как долго действуют приобретенные пакеты?",
    content:
      "Все купленные «Потоки», пакеты генераций изображений и пакеты видео-кредитов в Мастерской активны в течение 30 дней с момента оплаты (при новой покупке того же типа период продлевается с даты платежа). Мы работаем по месячному циклу, чтобы обеспечивать скорость серверов и актуальность инструментов. Неиспользованные остатки по истечении периода аннулируются.",
  },
  {
  ...
  },
  {
    ...
    content:
      "Конечно. Хотя мы делаем акцент на маркетплейсах, возможности системы гораздо шире. В «Свободном творчестве» вы можете создавать рекламные баннеры, креативы для постов, короткие видеоролики и обложки. Результаты можно скачивать и использовать на любых площадках.",
  },
]
