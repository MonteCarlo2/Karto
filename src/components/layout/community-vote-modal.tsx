...
const VOTE_REWARD_COPY =
  "За участие мы начислим 300 кредитов в свободном творчестве — сразу после успешного сохранения голоса.";

const VOTE_REWARD_COPY_THANKS =
  "Мы уже начислили вам 300 кредитов в свободном творчестве — удачных идей и сильных карточек!";
