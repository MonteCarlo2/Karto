...
/** Цены в рублях: Поток (1/5/15), Свободное творчество (10/30/100 ген.). Первый тариф — 10 ₽ для тестов. */
export const FLOW_PRICES = [10, 1190, 2990] as const;
export const CREATIVE_PRICES = [10, 590, 1490] as const;
