...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (
      ...
      const addAmount = CREDIT_PACKAGES[idx].credits;
      result = await addCredits(supabase, userId, addAmount);
      ...
      console.warn("[PAYMENT WEBHOOK] unknown payment_kind:", paymentKind);
