          ...
          <section suppressHydrationWarning>
            ...
            <div className="space-y-5" suppressHydrationWarning>
              ...
              <div suppressHydrationWarning>
                ...
                <p className="text-[15px] leading-6" suppressHydrationWarning>
                  Приобретённые пакеты «Потоков», кредитов в «Креатив» и ответов «Отзывы» имеют ограниченный срок действия — 30 (тридцать) календарных дней с момента оплаты (если иное не указано для бесплатных лимитов). По истечении срока неиспользованные остатки аннулируются без возврата средств. Управление автопродлением пакета «Отзывы» — в разделе «Профиль» и в{" "}
